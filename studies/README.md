...
project. Nothing has closed yet -- this is a fresh scaffold, and every
open question currently lives in `../experiments/README.md`. See the
main [README](../README.md) for the project itself.
